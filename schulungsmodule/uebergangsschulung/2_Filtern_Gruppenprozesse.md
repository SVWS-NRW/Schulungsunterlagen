...
:a: **Aufgabe 2.1 "Schüler nach Merkmalen filtern"**
+ Öffnen Sie SchILD3 und wählen Sie eine Datenbank aus.
+ Klicken Sie in SchILD3 auf "Auswahl". 
  ![SchILD3: Auswahl](Bilder/Filter_GP/Schild3_Auswahl_Filter_Menue.png)

+ Definieren Sie nun einen neuen Filter mit dem Namen "Abgaenger_SJ_2025_26":
    ...
    3. Wählen Sie in den "Abschnittsdaten" als "Schuljahr und Abschnitt" den Wert "2025/26 2 HJ." aus.
    4. Klicken Sie danach den Button "Testen".
       ![SchILD3: Filterkriterien festlegen](Bilder/Filter_GP/Schild3_Filter_Kriterien_festlegen.png)

    5. Es wird die ermittelte Schüleranzahl ausgegeben, die auf die UND-verknüpften Suchkriterien passen.
       ![SchILD3: Passende Schüler zu den Filterkriterien](Bilder/Filter_GP/Schild3_Filter_Testergebnis.png)

    6. Klicken Sie nun den Button "Übernehmen", um mit den gefilterten Daten weiterzuarbeiten.

    
:a: **Aufgabe 2.2 "Speichern Sie den getesteten Filter"**
...
:a: **Aufgabe 2.3 "Speichern Sie weitere Filter"**
...
:a: **Aufgabe 2.4 "Laden und verändern Sie ihre Filter"**
+ Klicken Sie in SchILD3 auf "Auswahl".
...
:a: **Aufgabe 2.5 "Erste Gruppenprozesse anwenden"**
+ Öffnen Sie SchILD3 und wählen Sie eine Datenbank aus.
+ Wählen Sie links über "Aktuelle Schülerauswahl" eine Klasse aus.
+ Klicken Sie danach in SchILD3 auf "Gruppenprozesse". 
  ![SchILD3: Gruppenprozesse](Bilder/Filter_GP/Schild3_Auswahl_GP_Menue.png)
...
+ Wählen Sie als GP unter "Allgemeines" - "Individualdaten ändern". 
...
:a: **Aufgabe 2.6 "Stundentafel den Schülern einer Klasse zuweisen"**
> [!TIP] Stundentafeln müssen zuvor unter "Kataloge" - "Stundentafeln" festgelegt worden sein.
