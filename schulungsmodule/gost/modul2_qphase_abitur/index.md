...
## 2.0 Orientierung in SchILD-NRW-3 und SVWS-Client
...
**Aufgaben 2.0 "SchILD-Leistungsdaten"**: Gehen Sie in die Leistungsdaten eines Schülers (m/w/d) in der Q2
...
**Aufgaben 2.0 "SchILD-NRW-3: Katalog Kurse"**: Wechseln Sie in den Katalog "Kurse" und orientieren Sie sich, welche Daten in den Kursen selbst abgelegt werden.

**Aufgaben 2.0 "SchILD Gruppenprozesse":** Wählen Sie über den Filter die Q2 exclusiv an und schauen Sie, welche Gruppenprozesse nun zur Verfügung stehen. Erklären Sie, wie anhang dieser Gruppenprozesse das Abitur verläuft.

**Aufgaben 2.0 "SVWS-Webclient: Leistungsdaten"**: Melden Sie sich im Webclient und gehen Sie bei Schülern in den aktuellen Lernabschnitt und orientieren Sie sich, wie Leistungsdaten hier erfasst werden.

**Aufgaben 2.0 "SVWS-Webclient: Katalog Kurse"**: Wechseln Sie in die *App Kurse* und orientieren Sie sich, wie Kurse erfasst werden. Stellen Sie Ihre Fragen im Plenum.

**Aufgaben 2.0 "App Oberstufe"**: Orientieren Sie sich in der App *Oberstufe*
...
**Aufgaben 2.1 "Filtern Sie auf den Jahrgang EF"**: Filtern Sie in der *App Schüler* auf den Jahrgang EF und wechseln Sie auf den Reiter *Laufbhanplanung*.
...
**Aufgaben 2.1 "Kontrollieren Sie die Kurwahlen"**: Kontrollieren Sie nun Ihre Kurswahlen der **aktuellen EF**.
...
**Aufgaben 2.1 "Zusammenfassung über Fachwahlen"**: Nach der Wahl und Korrektur nutzen Sie den *Tab Fachwahlen* um eine Übersicht über alle Wahlen anzeigen zu lassen.
...
**Aufgaben 2.2 "Orientieren im Blockungsbereich der Kursplanung"**: Gehen Sie für Ihren **Gewählten Abiturjahrgang** in den *Tab Kursplanung*.
...
**Aufgabe 2.2 "Stumpf drauflos blocken"**: Wir legen einfach los!
...
**Aufgabe 2.2 "Mit Nachdenken und Planung blocken"**: 
...
**Aufgabe 2.2 "Weiterplanen und Schüler zuordnen"**: Wir können auch Kurse schon fest setzen
