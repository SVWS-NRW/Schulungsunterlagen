...
3. Ergänzen Sie Niederländisch als neu einsetzende Fremdsprache in der EF (oder ein/mehrere andere Fächer gemäß den Vorgaben an Ihrer Schule). Dies kann durchaus auch im Webclient realisiert werden.
4. Kontrollieren Sie die Stündigkeit - insbesondere bei den neu einsetzenden Fremdsprachen und korrigieren Sie diese ggf.
5. Passen Sie die LK-Wahlmöglichkeiten sowie die Wahl des dritten und vierten Abiturfaches an. Gemäß den Vorgaben Ihrer Schule oder nach diesen Vorgaben:  
...
6. Richten Sie einen Projektkurs ein. z.B. für das Leitfach Informatik.

:information_source: [Infos zur Fächerangabe](https://doku.svws-nrw.de/svws-client/apps/gost/faecher/#angebotene-facher)
...
:information_source: [Infos zu geforderten Fächerkombinationen.](https://doku.svws-nrw.de/svws-client/apps/gost/faecher/#geforderte-kombinationen)
...
:information_source: [Infos zu unzulässigen Fächerkombinationen.](https://doku.svws-nrw.de/svws-client/apps/gost/faecher/#unzulassige-kombinationen)
...
:information_source:[Infos zum Tab Beratung.](https://doku.svws-nrw.de/svws-client/apps/gost/beratung/)
...
:information_source: [Eine Anleitung finden Sie hier](https://doku.svws-nrw.de/svws-client/apps/gost/#abiturjahrgang).
...
:information_source: [Hinweise zur Eingabe des Beratungslehrers und der Textvorlagen.](https://doku.svws-nrw.de/svws-client/apps/gost/beratung/#beratungslehrer-hinterlegen)
...
:information_source: [Infos zum Laufbahn-Tab.](https://doku.svws-nrw.de/svws-client/apps/gost/laufbahn/#laufbahnen)  
